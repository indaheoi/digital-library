<template>
    ...
    <section class=" pt-20  bg-lavender pb-3">
        <div class="flex justify-center align-center items-center">
            <div class="card lg:w-[700px] md:w-[500px] bg-base-100 h-[400px] shadow-inner shadow-darkgray">
                <h2 class="card-title bg-navy rounded-t-2xl justify-center text-2xl text-white textarea-lg">Silahkan Isi
                    Form Kunjungan</h2>
                <div class="card-body">
                    ...
                    <form @submit.prevent="kirimData" class="space-y-4 md:space-y-6">
                        <div>
                            <input v-model="form.nama" type="text"
                                class="bg-lightgray border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 light:bg-light-700 dark:border-gray dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div v-if="form.keanggotaan == '1'"
                            ...
                            <div class="sm:col-span-2 ">
                                <select v-model="form.kelas" id="kelas" name="kelas"
                            ...
                            <div class="sm:col-span-2">
                                <select v-model="form.jurusan" id="jurusan" name="jurusan"
                                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-center"
                                    required="">
                            ...
                            <div class="sm:col-span-2">
                                <select v-model="form.rombel" id="rombel" name="rombel"
                                    class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm text-center"
                                    required="">
                        ...
                        <div>
                            ...
                            <label for="keperluan"
                                class="shadow-inner block mb-2 text-sm font-medium text-darkgray  dark:text-dark ">keperluan</label>
                            <select v-model="form.keperluan" x-data="select({'keperluan'})" id="kategori"
                                class="bg-lightgray border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 light:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                required="">

                                <option v-for="(visit, i) in visitors" :key="i" :value="visit.id">{{ visit.nama }}
                                </option>
        ...
        <div class="py-8 lg:ps-52">
            <div class="flex justify-center ms-96">
                <NuxtLink to="/pengunjung/riwayat"><button class="btn btn-md bg-navy text-white text-lg">Lihat</button>
                </NuxtLink>
            </div>
        </div>
        <NuxtLink to="/"><button class="btn btn-circle shadow-inner shadow-darkgray ms-24 mt-20">
